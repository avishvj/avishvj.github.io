...
+ Split Bregman iteration [removed sidenote]
+ Dykstra's alternating projection algorithm [removed sidenote]
...
+ Embraces distributed computing for big data [removed sidenote]
